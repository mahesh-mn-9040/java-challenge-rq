...
class EmployeeControllerTest {
    ...
    void getEmployeesByNameSearch_Success() throws Exception {
        ...
        when(employeeService.getEmployeesByNameSearch("X")).thenReturn(filteredEmployees);
    ...
    void getEmployeesByNameSearch_InvalidSearchString() throws Exception {
        ...
        when(employeeService.getEmployeesByNameSearch("X@123"))
                .thenThrow(new IllegalArgumentException("Search string must contain only letters"));

        // When & Then
        mockMvc.perform(get("/api/v1/employee/search/X@123"))
    ...
    void getEmployeeById_Success() throws Exception {
        ...
        when(employeeService.getEmployeeById(employeeId)).thenReturn(Optional.of(testEmployee1));
    ...
    void deleteEmployeeById_Success() throws Exception {
        // Given
        String employeeId = UUID.randomUUID().toString();
        when(employeeService.deleteEmployeeById(employeeId)).thenReturn("Employee X");
